...
3. `File > Export to Mod` ile çıktıyı `release/zarg4n Career Overhaul 0.2.0.fifamod` olarak üret.
4. `FCGameplay`, attribulator veya başka modlara ait varlık ekleme.
...
3. Use `File > Export to Mod` and write `release/zarg4n Career Overhaul 0.2.0.fifamod`.
4. Do not add `FCGameplay`, attribulator or assets from other mods.
